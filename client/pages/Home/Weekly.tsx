        ...
        <div className="font-poppins w-full max-w-6xl px-4 sm:px-8 lg:px-16">
          <div className="relative font-poppins grid grid-cols-4 gap-4">
            ...
            <div className="bg-orange-700 rounded-lg p-4">
              <DailyTileContainer title={'Work'} mode={'weekly'} />
            </div>
            <div className="bg-green-600 rounded-lg p-4">
              <DailyTileContainer title={'Play'} mode={'weekly'} />
            </div>
            <div className="bg-red-600 rounded-lg p-4">
              <DailyTileContainer title={'Study'} mode={'weekly'} />
            </div>
            <div className="bg-blue-600 rounded-lg p-4">
              <DailyTileContainer title={'Exercise'} mode={'weekly'} />
            </div>
            <div className=" bg-purple-600 rounded-lg p-4">
              <DailyTileContainer title={'Social'} mode={'weekly'} />
            </div>
            <div className=" bg-yellow-600 rounded-lg p-4">
              <DailyTileContainer title={'Self Care'} mode={'weekly'} />
            </div>
          </div>
        </div>
      </div>
